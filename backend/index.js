...
if (prod) {
  ...
  app.use(cors({ origin: 'http://ec2-15-165-123-14.ap-northeast-2.compute.amazonaws.com/', credentials: true }));
} else {
  app.use(morgan("dev"));
...
app.use(
  expressSession({
    ...
    cookie: {
      ...
      // domain: prod && 'http://ec2-15-165-123-14.ap-northeast-2.compute.amazonaws.com/',
    },
    name: 'rnbck',
  })
);
